...
window.SITE_CONFIG = {
  "ncartificialintelligence.com": {
    ...
    ctaNote: "Local and in person. Straightforward rates for the NC businesses we partner with.",
    // SEO
    keywords:
  ...
  "caryncai.com": {
    ...
    ctaNote: "Based in Cary — let's meet in person. Straightforward rates for the Cary businesses we partner with.",
    // SEO
    keywords:
  ...
  "rtpaisolutions.com": {
    ...
    ctaNote: "Local and on-site. Straightforward rates for our Triangle partners.",
    // SEO
    keywords:
